...
# vespa, vespula, vespine branch, agelaia and brachy foreground in model 2
species="complexVSall"
...
cp input/branch-models/config-files/template_M0.ctl ${orthogroup}_M0.ctl

# update the orthogroup name
sed --in-place "s/OG/${orthogroup}/g" ${orthogroup}_M0.ctl

# update the species name
sed --in-place "s/agelaia/${species}/g" ${orthogroup}_M0.ctl
...
cp input/branch-models/config-files/template_M2.ctl ${species}-${orthogroup}_M2.ctl

# update the orthogroup name
sed --in-place "s/OG/${orthogroup}/g" ${species}-${orthogroup}_M2.ctl

# update the species name
sed --in-place "s/agelaia/${species}/g" ${species}-${orthogroup}_M2.ctl
