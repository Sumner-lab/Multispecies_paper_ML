...
sed --in-place "s/agelaia/${spe}/g" input/branch-site-models/config-files/${species}-${orthogroup}_omegaFixed.ctl
...
# update the species name in the tree file
sed --in-place "s/agelaia/${spe}/g" input/branch-site-models/config-files/${species}-${orthogroup}_omegaNotFixed.ctl
