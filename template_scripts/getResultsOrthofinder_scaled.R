...
matrix_real.tpm.filter.scale <- t(scale(t(matrix_real.tpm.filter))) #Scale by row, but NOT by column, as this changes the direction of up-down regulation
...
matrix_real.UNQ.filter.scale <- t(scale(t(matrix_real.UNQ.filter))) #Scale by row, but NOT by column, as this changes the direction of up-down regulation
...
matrix_real.TPM_UNQUANT.filter.scale <- t(scale(t(matrix_real.TPM_UNQUANT.filter)))
...
matrix_run7.filter.scale <- t(scale(t(matrix_run7.filter)))
...
caste <- grepl("Worker|NonReproductive", colnames(matrix_real.UNQ.filter.scale.train))
...
boxplot(matrix_real.UNQ.filter.scale)
dev.off()
...
for(i in 1:dim(matrix_real.UNQ.filter.scale.train[ , ])[1]){
  
  data <- data.frame(caste = caste, expr = as.numeric(matrix_real.UNQ.filter.scale.train[i, ]))
...
play<-as.data.frame(matrix_real.UNQ.filter.scale.train, h=T)
...
pheatmap(matrix_real.UNQ.filter.scale.train[])
dev.off()

data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.train[]))
...
pheatmap(matrix_real.UNQ.filter.scale.train[p.coeffs.sig, ])
dev.off()
...
pheatmap(matrix_real.UNQ.filter.scale.train[p.coeffs.sig2, ])
dev.off()
...
data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.train[p.coeffs.sig, ]))
...
pheatmap(matrix_real.UNQ.filter.scale.train[q.coeffs.sig, ])
dev.off()

data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.train[q.coeffs.sig, ]))
...
if (length(species.test) >= 2){
  ...
  pheatmap(matrix_real.UNQ.filter.scale.test[])
  data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.test[]))
  dev.off()
  ...
  pheatmap(matrix_real.UNQ.filter.scale.test[p.coeffs.sig, ])
  data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.test[p.coeffs.sig, ]))
  dev.off()
  ...
  pheatmap(matrix_real.UNQ.filter.scale.test[q.coeffs.sig, ])
  data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.test[q.coeffs.sig, ]))
  dev.off()
...
pheatmap(matrix_real.UNQ.filter.scale.together[p.coeffs.sig, ])
dev.off()
pdf(file = paste("FIGURES/Figure_of_Classifiers/VERSION_RUN/Together_PCA.p_coeff.pdf"), width = 3 * 1.5 * 3.54, height = 1.5 * 3.54)
data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.together[p.coeffs.sig, ]))
plot(data.pca$x[ , 1], data.pca$x[ , 2])
text(data.pca$x[ , 1], data.pca$x[ , 2], labels=rownames(data.pca$x), cex= 0.7, pos=3)
...
pheatmap(matrix_real.UNQ.filter.scale.together[q.coeffs.sig, ])
dev.off()
pdf(file = paste("FIGURES/Figure_of_Classifiers/VERSION_RUN/Together_PCA.q_coeff.pdf"), width = 3 * 1.5 * 3.54, height = 1.5 * 3.54)
data.pca <- prcomp(t(matrix_real.UNQ.filter.scale.together[q.coeffs.sig, ]))
plot(data.pca$x[ , 1], data.pca$x[ , 2])
text(data.pca$x[ , 1], data.pca$x[ , 2], labels=rownames(data.pca$x), cex= 0.7, pos=3)
...
if (length(species.train) >= 4){
  ...
  data <- t(scale(t(matrix_real.UNQ.filter.scale.train[, ])))
  ...
  data <- t(scale(t(matrix_real.UNQ.filter.scale.train[p.coeffs.sig, ])))
  ...
  data <- t(scale(t(matrix_real.UNQ.filter.scale.train[q.coeffs.sig, ])))
...
data.train <- t(scale(t(matrix_real.UNQ.filter.scale.train[, ])))
data.test <- t(scale(t(matrix_real.UNQ.filter.scale.test[ ])))
...
data.train <- t(scale(t(matrix_real.UNQ.filter.scale.train[p.coeffs.sig, ])))
data.test <- t(scale(t(matrix_real.UNQ.filter.scale.test[p.coeffs.sig, ])))
...
data.train <- t(scale(t(matrix_real.UNQ.filter.scale.train[q.coeffs.sig, ])))
data.test <- t(scale(t(matrix_real.UNQ.filter.scale.test[q.coeffs.sig, ])))
...
data <- t(scale(t(matrix_real.UNQ.filter.scale.train[, ])))
num.genes <- dim(matrix_real.UNQ.filter.scale.train)[1]
...
for(i in 1:length(filter.num)){
  ...
  cat(paste("Process step (out of 100): ", i, "\n"))
